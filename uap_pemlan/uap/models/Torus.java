...
public class Torus extends Shape implements ThreeDimensional, PIPRequired, MassCalculable, MassConverter, ShippingCostCalculator {
    ...
    public double getMass() {
        return getVolume() * DENSITY * (THICKNESS / minorRadius);
    }
